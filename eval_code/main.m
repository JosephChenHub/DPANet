...
datasets = {
   'RGBD135'; 'SSD100'; 'LFSD'; 'SIP'; 
   'NJUD'; 'NLPR'; 'STEREO797'; 'DUT'  
};
...
for i = 1:numel(algorithms)
    ...
    for j = 1:numel(datasets)
        dataset      = datasets{j};
        predpath     = ['./rgbd_maps/' alg '/' dataset '/'];
        maskpath     = ['../data/RGBD_sal/test/' dataset '/mask/'];
        ...
        else names        = textread(['../data/RGBD_sal/test/' dataset '/test.txt'], '%s'); end
